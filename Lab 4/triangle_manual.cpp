...
//"{\n"
//"float cx = floor(checker_size * uv.x);\n"
//"float cy = floor(checker_size * uv.y);\n"
...
//        int vertexColorLocation = glGetUniformLocation(shaderProgram, "texsize");
//        glUseProgram(shaderProgram);
//        glUniform2f(vertexColorLocation, 0.5f, 0.5f);
//
//
//        int vertexColorLocation1 = glGetUniformLocation(shaderProgram, "checker_size");
//        glUseProgram(shaderProgram);
//        glUniform1f(vertexColorLocation1, 5);
//
