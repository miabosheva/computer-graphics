...
//    // ------------------------------------
//    std::string shader_location("C:/Users/Mia/code/OpenGLPrj/res/shaders/");
//    std::string texture_location("C:/Users/Mia/code/OpenGLPrj/res/textures/");
//
...
//        loadTexture((texture_location + "container2.jpg").c_str());
//
//
//
//    unsigned int specularMap = loadTexture((texture_location + "container2_specular.jpg").c_str());
//
//    unsigned int emmisionMap = loadTexture((texture_location + "matrix.jpg").c_str());
//
